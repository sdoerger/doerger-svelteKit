<script>
	...
	// 		und/oder Rechenkapazitäten); Dienstanbieter: Amazon Web Services, Inc., 410 Terry Avenue
	// 		North, Seattle WA 98109, USA; Website:
	// 		<a href="https://aws.amazon.com/de/" target="_blank">https://aws.amazon.com/de/</a>;
	// 		Datenschutzerklärung:
	// 		<a href="https://aws.amazon.com/de/privacy/?nc1=f_pr" target="_blank"
	// 			>https://aws.amazon.com/de/privacy/?nc1=f_pr</a
	// 		>; Standardvertragsklauseln (Gewährleistung Datenschutzniveau bei Verarbeitung in
	// 		Drittländern):
	// 		<a href="https://d1.awsstatic.com/Processor_to_Processor_SCCs.pdf" target="_blank"
	// 			>https://d1.awsstatic.com/Processor_to_Processor_SCCs.pdf</a
	// 		>,
	// 		<a href="https://d1.awsstatic.com/Controller_to_Processor_SCCs.pdf" target="_blank"
	// 			>https://d1.awsstatic.com/Controller_to_Processor_SCCs.pdf</a
	// 		>;
	// 		<a href="https://aws.amazon.com/de/compliance/gdpr-center/" target="_blank"
	// 			>https://aws.amazon.com/de/compliance/gdpr-center/</a
...
<div class="px-10 lg:px-24 text-sdlightGrey-50 lg:text-2xl break-words">
	...
	<ul class="index">
		...
		<li>
			<a class="index-link" href="#m3575"
				>Im Rahmen der Geschäftstätigkeit eingesetzte Anbieter und Services</a
			>
		</li>
		<li>
	...
	<p>Stefan Dörger<br />Kastanienweg 12B<br />37186 Moringen<br />Deutschland</p>
	...
	<h4
		class="text-sdGreen-400 pb-4 tracking-tighter font-bold uppercase leading-none md:mx-auto font-josefinSans text-xl mt-20"
	>
	...
	<p>
		<strong>SSL-Verschlüsselung (https)</strong>: Um Ihre via unserem Online-Angebot übermittelten
	...
	<p>
		...
		gesetzlicher Pflichten erforderlich ist oder mit Einwilligung der betroffenen Personen erfolgt
		(z.B. an beteiligte Telekommunikations-, Transport- und sonstige Hilfsdienste sowie
		Subunternehmer, Banken, Steuer- und Rechtsberater, Zahlungsdienstleister oder Steuerbehörden).
		Über weitere Verarbeitungsformen, z.B. zu Zwecken des Marketings, werden die Vertragspartner im
	...
	<p>
		...
		Auftrags durch den Vertragspartner offengelegt wurden, löschen wir entsprechend den Vorgaben des
	...
	<p>
		<strong>Agenturdienstleistungen</strong>: Wir verarbeiten die Daten unserer Kunden im Rahmen
		unserer vertraglichen Leistungen, zu denen z.B. konzeptionelle und strategische Beratung,
	...
	<ul class="m-elements">
		...
		<li>
			...
			Kontaktanfragen und Kommunikation, Büro- und Organisationsverfahren, Verwaltung und Beantwortung
			von Anfragen.
		</li>
		<li>
			<strong>Rechtsgrundlagen:</strong> Vertragserfüllung und vorvertragliche Anfragen (Art. 6 Abs.
			1 S. 1 lit. b. DSGVO), Rechtliche Verpflichtung (Art. 6 Abs. 1 S. 1 lit. c. DSGVO), Berechtigte
			Interessen (Art. 6 Abs. 1 S. 1 lit. f. DSGVO).
		</li>
	</ul>
	<h3 id="m3575">Im Rahmen der Geschäftstätigkeit eingesetzte Anbieter und Services</h3>
	<p>
		Im Rahmen unserer Geschäftstätigkeit setzen wir unter Beachtung der gesetzlichen Anforderungen
		weitere Dienstleistungen, Plattformen, Schnittstellen oder Plugins von Drittanbietern (kurz
		"Services") ein, die Daten der Nutzer verarbeiten können. In diesem Zusammenhang gelten
		zusätzlich zu unseren Datenschutzhinweisen die Datenschutzhinweise der jeweiligen Services.
	</p>
	<p>
		<strong>Hinweise zu Rechtsgrundlagen:</strong> Sofern wir die Nutzer um deren Einwilligung
		<span class="dsg-license-content-blurred de" />
		Auf welcher Rechtsgrundlage wir Ihre personenbezogenen Daten mit Hilfe von Cookies verarbeiten, hängt
		davon ab, ob wir Sie um eine Einwilligung bitten. Falls dies zutrifft und Sie in die Nutzung von
		Cookies einwilligen, ist die Rechtsgrundlage der Verarbeitung Ihrer Daten die erklärte Einwilligung.
		...
		verarbeitet oder, wenn der Einsatz von Cookies erforderlich ist, um unsere vertraglichen Verpflichtungen
		zu erfüllen.
	</p>
	<div class="dsg-license-content-blurred">
		<ul class="m-elements">
			<li>
				<strong>Betroffene Personen:</strong> Kunden, Interessenten, Nutzer (z.B. Webseitenbesucher,
			...
			<li>
				<strong>Rechtsgrundlagen:</strong> Einwilligung (Art. 6 Abs. 1 S. 1 lit. a. DSGVO), Vertragserfüllung
				und vorvertragliche Anfragen (Art. 6 Abs. 1 S. 1 lit. b. DSGVO), Berechtigte Interessen (Art.
	...
	<ul class="m-elements">
		<li>
			<strong>DigitalOcean:</strong> Leistungen auf dem Gebiet der Bereitstellung von
			informationstechnischer Infrastruktur und verbundenen Dienstleistungen (z.B. Speicherplatz
			und/oder Rechenkapazitäten); Dienstanbieter: DigitalOcean, LLC, 101 Avenue of the Americas,
			New York, New York 10013, USA; Website:
			<a href="https://www.digitalocean.com/" target="_blank">https://www.digitalocean.com/</a>;
			Datenschutzerklärung:
			<a href="https://www.digitalocean.com/legal/privacy-policy" target="_blank"
				>https://www.digitalocean.com/legal/privacy-policy</a
			>; Auftragsverarbeitungsvertrag:
			<a href="https://www.digitalocean.com/legal/data-processing-agreement/" target="_blank"
				>https://www.digitalocean.com/legal/data-processing-agreement/</a
			>.
		</li>
	</ul>
	<h3 id="m391">Kommunikation via Messenger</h3>
	<p>
	...
	<p>
		<strong>Hinweise zu Rechtsgrundlagen: </strong> Sofern wir Kommunikationspartner vor der Kommunikation
		mit ihnen via Messenger um eine Erlaubnis bitten, ist die Rechtsgrundlage unserer Verarbeitung ihrer
		Daten deren Einwilligung. Im Übrigen, falls wir nicht um eine Einwilligung bitten und sie z.B. von
		sich aus Kontakt mit uns aufnehmen, nutzen wir Messenger im Verhältnis zu unseren Vertragspartnern
		sowie im Rahmen der Vertragsanbahnung als eine vertragliche Maßnahme und im Fall anderer Interessenten
		und Kommunikationspartner auf Grundlage unserer berechtigten Interessen an einer schnellen und effizienten
	...
	<p>
		<strong>Widerruf, Widerspruch und Löschung:</strong> Sie können jederzeit eine erteilte Einwilligung
		widerrufen und der Kommunikation mit uns via Messenger jederzeit widersprechen. Im Fall der Kommunikation
		via Messenger löschen wir die Nachrichten entsprechend unseren generellen Löschrichtlinien (d.h.
		z.B., wie oben beschrieben, nach Ende vertraglicher Beziehungen, im Kontext von Archivierungsvorgaben
		etc.) und sonst, sobald wir davon ausgehen können, etwaige Auskünfte der Kommunikationspartner beantwortet
		zu haben, wenn kein Rückbezug auf eine vorhergehende Konversation zu erwarten ist und der Löschung
		keine gesetzlichen Aufbewahrungspflichten entgegenstehen.
	</p>
	<p>
		<strong>Vorbehalt des Verweises auf andere Kommunikationswege:</strong> Zum Abschluss möchten wir
		darauf hinweisen, dass wir uns aus Gründen Ihrer Sicherheit vorbehalten, Anfragen über Messenger
		nicht zu beantworten. Das ist der Fall, wenn z.B. Vertragsinterna besonderer Geheimhaltung bedürfen
		oder eine Antwort über Messenger den formellen Ansprüchen nicht genügt. In solchen Fällen verweisen
		wir Sie auf adäquatere Kommunikationswege.
	</p>
	<div class="dsg-license-content-blurred">
		<ul class="m-elements">
			<li>
				<strong>Verarbeitete Datenarten:</strong> Kontaktdaten (z.B. E-Mail, Telefonnummern), Nutzungsdaten
				(z.B. besuchte Webseiten, Interesse an Inhalten, Zugriffszeiten), Meta-/Kommunikationsdaten (z.B.
				Geräte-Informationen, IP-Adressen).
			</li>
	...
	<p>
		Nach Widerruf bzw. Widerspruch können wir die zum Nachweis der Einwilligung erforderlichen Daten
		bis zu drei Jahren auf Grundlage unserer berechtigten Interessen speichern, bevor wir sie
	...
	<p>
		<strong>Facebook-Seiten</strong>: Wir sind gemeinsam mit Facebook Irland Ltd. für die Erhebung
		(jedoch nicht die weitere Verarbeitung) von Daten der Besucher unserer Facebook-Seite (sog.
		"Fanpage") verantwortlich. Zu diesen Daten gehören Informationen zu den Arten von Inhalten, die
		...
		>), in der insbesondere geregelt wird, welche Sicherheitsmaßnahmen Facebook beachten muss und in
		der Facebook sich bereit erklärt hat die Betroffenenrechte zu erfüllen (d. h. Nutzer können z.
	...
	<ul class="m-elements">
		<li>
			<strong>Verarbeitete Datenarten:</strong> Kontaktdaten (z.B. E-Mail, Telefonnummern), Inhaltsdaten
		...
		<li>
			<strong>Zwecke der Verarbeitung:</strong> Kontaktanfragen und Kommunikation, Feedback (z.B. Sammeln
	...
	<ul class="m-elements">
		...
		<li>
			<strong>LinkedIn:</strong> Soziales Netzwerk; Dienstanbieter: LinkedIn Ireland Unlimited
		...
		<li>
			<strong>Twitter:</strong> Soziales Netzwerk; Dienstanbieter: Twitter International Company,
			One Cumberland Place, Fenian Street, Dublin 2 D02 AX07, Irland, Mutterunternehmen: Twitter
			Inc., 1355 Market Street, Suite 900, San Francisco, CA 94103, USA; Datenschutzerklärung:
		...
		<li>
			<strong>Xing:</strong> Soziales Netzwerk; Dienstanbieter: XING AG, Dammtorstraße 29-32, 20354
			Hamburg, Deutschland; Website:
			<a href="https://www.xing.de" target="_blank">https://www.xing.de</a>; Datenschutzerklärung:
	...
	<ul>
		<li>
			<strong
				...
				Profiling, soweit es mit solcher Direktwerbung in Verbindung steht.</strong
			>
		</li>
		<li>
		...
		<li>
			...
			in dem Mitgliedstaat ihres gewöhnlichen Aufenthaltsorts, ihres Arbeitsplatzes oder des Orts des
	...
	<ul class="glossary">
		<li>
			...
			zu einer Online-Kennung (z.B. Cookie) oder zu einem oder mehreren besonderen Merkmalen identifiziert
