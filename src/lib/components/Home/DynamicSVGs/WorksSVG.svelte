...
{#if svgVisible}
	<svg
		class="h-56 w-56 drop-shadow-md {svgColor} fill-current text-sdDarkGrey-400 stroke-current"
		id="Capa_1"
	...
	>
		<g transform="translate(0.000000,512.000000) scale(0.100000,-0.100000)">
			<path
				class="sd-anima-stroke"
				in:draw={{ duration: 800 }}
				fill={svgFill}
				d="M210 2775 l0 -2345 215 0 215 0 0 -215 0 -215 106 71 106 71 106 -71
 ...
 0 0 500 0 500 140 0 140 0 0 -500z"
			...
			<path
				in:fade={{ delay: 400 }}
				d="M1679 3480 c-104 -18 -202 -99 -239 -198 -29 -76 -25 -186 8 -254 46
 ...
 -162 -97 -7 -150 50 -150 162 0 112 53 169 150 162 38 -3 59 -10 78 -28z"
			...
			<path
				in:fade={{ delay: 400 }}
				d="M880 3165 l0 -315 85 0 85 0 0 95 0 95 50 0 c163 0 263 84 263 220 0
 ...
 -17z"
			...
			<path
				in:fade={{ delay: 400 }}
				d="M2150 3165 l0 -315 85 0 85 0 0 96 0 95 36 -3 c34 -3 39 -8 88 -93
 ...
 l-64 0 0 65 0 65 65 0 c56 0 66 -3 76 -22z"
			...
			<path
				in:fade={{ delay: 400 }}
				d="M2710 3405 l0 -75 90 0 90 0 0 -240 0 -240 90 0 90 0 0 240 0 240 90
 0 90 0 0 75 0 75 -270 0 -270 0 0 -75z"
			/>
			<path
				in:fade={{ delay: 400 }}
				d="M880 2380 l0 -320 85 0 85 0 0 120 0 120 110 0 110 0 0 70 0 69 -107
 3 -108 3 0 50 0 50 133 3 133 3 -3 72 -3 72 -217 3 -218 2 0 -320z"
			/>
			<path
				in:fade={{ delay: 400 }}
				d="M1575 2688 c-87 -32 -166 -108 -196 -188 -60 -157 9 -334 159 -407
 ...
 284 41 21 105 16 145 -13z"
			...
			<path
				in:fade={{ delay: 400 }}
				d="M2090 2380 l0 -320 228 2 227 3 3 78 3 77 -146 0 -145 0 0 240 0 240
 -85 0 -85 0 0 -320z"
			/>
			<path
				in:fade={{ delay: 400 }}
				d="M2622 2383 l3 -318 85 0 85 0 3 318 2 317 -90 0 -90 0 2 -317z"
			/>
			<path
				in:fade={{ delay: 400 }}
				d="M3120 2691 c-117 -36 -212 -143 -229 -258 -20 -141 51 -278 177 -340
